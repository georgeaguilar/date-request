...
export default function Step2DateTime({ initialDate, initialTime, onNext, onBack }: Props) {
  ...
  const inputClass =
    "w-full px-4 py-3 rounded-xl border border-rose-900/50 bg-rose-950/30 text-rose-100 text-sm outline-none focus:border-rose-500 focus:ring-2 focus:ring-rose-900/50 transition mb-4 [color-scheme:dark]";
